...
const initialPosts: BlogPost[] = [
  {
    ...
    views: 1240,
    linkedProducts: [
      { id: 1, name: "Gold Pendant", price: "₹ 1,850", image: "" },
    ],
    activeOffer: "WELCOME2024",
  },
  {
    id: 2,
    title: "The Rise of Minimalist Decor in 2026",
    author: "Sara V.",
    category: "Trends",
    date: "Jan 28, 2026",
    status: "Published",
    views: 842,
    linkedProducts: [
      { id: 2, name: "Wall Sconce", price: "₹ 1,200", image: "" },
    ],
  },
  {
    id: 3,
    title: "5 Maintenance Tips for Brass Chandeliers",
    author: "Admin",
            ...
            <tbody className="divide-y divide-border">
              {posts.map((post) => (
                ...
                >
                    ...
                    <div className="flex flex-col gap-1.5">
                      <div className="flex -space-x-1.5">
                        {post.linkedProducts.length > 0 ? (
                          post.linkedProducts.map((_, i) => (
                            <div
                              key={i}
                              className="w-6 h-6 rounded-full border border-white bg-secondary flex items-center justify-center"
                            >
                      ...
                      {post.activeOffer && (
                        <span className="flex items-center gap-1 text-[9px] font-bold text-accent uppercase tracking-tighter">
                          <Ticket className="w-2.5 h-2.5" /> {post.activeOffer}
                        </span>
                      )}
                    </div>
                  </td>
                  ...
                  <td className="px-6 py-4">
                    <Link
                      to={`/content/blogs/${post.id}/analytics`}
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-1">
                      ...
                      <button className="p-2 hover:bg-white text-muted hover:text-red-500 rounded-xl border border-transparent hover:border-border transition-all">
